    ...
    <div @keydown.esc="closeModal">
        <b-row id="toolbar">
            <div>
                ...
                <b-button-group v-if="showToolbar && this.user" class="mx-1">
              ...
              >
                No keyboard selected
                        ...
                        <b-dropdown-item
                            v-for="(keeb, index) in this.user.keyboards"
                            :key="index"
        ...
        <b-card id="typer-card">
            <b-modal ref="done-modal" block centered hide-footer hide-header>
                <h2>
                    WPM: {{ (60 / (this.resultTime / 1000) * (this.characters / 5)).toFixed(2) }}
                </h2>
                <h5>
                    Accuracy adjusted WPM: {{ ((60 / (this.resultTime / 1000) * (this.characters /
