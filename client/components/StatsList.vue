                ...
                <b-card-body>
                    ...
                    >
                        ...
                        <template v-slot:cell(user)="data">
                            <div>
                                <b-avatar
                                    :src="`https://click-clack.cc:5000/files/images/${data.value}.jpg`"
                                    button
                                    class="avatar"
                                    size="2rem"
                                    variant="light"
    ...
    export default {
        ...
        methods: {
            loadData () {
                try {
                    if (this.user) {
                        statService.getStats(this.user._id).then((result) => {
                            this.stats = result
                            this.fillData()
                            this.loading = false
                        ...
                        statService.getStats().then((result) => {
                            this.stats = result
                            this.fillData()
                            this.loading = false
                        })
