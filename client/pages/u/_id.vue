...
export default {
	...
	async asyncData ({ params, app }) {
		const u = await app.$services.userService.getUser(params.id)
		u.listings = await app.$services.listingService.getListings(u._id)
		u.keyboards = await app.$services.keyboardService.getKeyboards(u._id)
		u.posts = await app.$services.postService.getPosts(u._id)
