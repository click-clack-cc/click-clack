<template>
    <div>
        <b-card id='container' >
        <h4>
            {{this.edit?"Update Post":"New Post"}}
        </h4>
        <br>
        ...
        <card class='photoPreview' style='max-width: 10rem; max-height: 10rem; margin: 0.5rem' v-for='(img, index) in post.images' v-bind:key='index'>
        ...
        <b-row>
                <b-col>
                    <b-form-group label="Title">
                        <b-form-input :disabled='this.edit' v-model='post.title'
        ...
        <b-row>
            <b-col>
                ...
                <b-form-checkbox v-model="preview" name="check-button" switch>
                    ...
                    You can format your post using markdown. Learn about it <a style='font-size: small'
            ...
            <b-col v-if='preview'>
                Preview
                <div v-html="$md.render( post.content?post.content:``)"></div>
            </b-col>
        </b-row>
        <br>
    ...
    export default {
        ...
        methods: {
            async submit() {
                ...
                postService.newPost(this.user._id, this.edit, {
                    _id: this.post._id,
