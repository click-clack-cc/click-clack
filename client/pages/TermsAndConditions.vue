...
export default {
	...
	head () {
		const description = "Let's keep Click-Clack an organized and friendly place by following these simple rules."
		const title = 'Click-Clack Terms and Conditions'
		const url = 'https://click-clack.cc/termsandconditions'
		return {
			title,
			htmlAttrs: {
				lang: 'en'
